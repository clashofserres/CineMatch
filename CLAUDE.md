...
- **`com.clashofserres.cinematch.base`**: Reusable components and base classes for all features
...
- **`com.clashofserres.cinematch.examplefeature`**: Example feature demonstrating the structure
...
1. Create a new package under `com.clashofserres.cinematch` (e.g., `com.clashofserres.cinematch.myfeature`)
